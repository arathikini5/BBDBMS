...
<br>
        <h1 style="text-align:center;font_size:45px;font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif ;">Welcome to BloodBank & Donor Management System</h1>
<br>
        <div class="row">
